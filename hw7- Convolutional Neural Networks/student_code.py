...
class LeNet(nn.Module):
    def __init__(self, input_shape=(32, 32), num_classes=100):
        super(LeNet, self).__init__()  # why is in_channels 3 -> 3 colors
    ...
    def forward(self, x):
        ...
        # end step 2
        out = out.view(-1, 16 * 5 * 5)  # https://stackoverflow.com/questions/42479902/how-does-the-view-method-work-in
        # -pytorch/42482819#42482819
...
def count_model_params():
    ...
    # https://pytorch.org/docs/master/generated/torch.nn.Module.html#torch.nn.Module.named_parameters
